...
export default function ValentinePage({ }: ValentinePageProps) {
  ...
  return (
    <div className="scrapbook-page paper-texture relative overflow-hidden">
            ...
            >
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={handleYes}
                  className="px-8 py-4 bg-blush text-white font-body font-semibold text-lg rounded-full shadow-lg hover:shadow-xl transition-shadow min-w-[160px]"
                >
                  Yes 💖
                </motion.button>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={handleYes}
                  className="px-8 py-4 bg-sage text-white font-body font-semibold text-lg rounded-full shadow-lg hover:shadow-xl transition-shadow min-w-[160px]"
                >
                  Obviously 💘
                </motion.button>
              </motion.div>
      ...
      >
        <svg width="80" height="80" viewBox="0 0 80 80" className="text-blush">
          <path
